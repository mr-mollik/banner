...
clear
TNAME="$PROC";
echo -e "\033[32m$(figlet -f MR MOLLIK.flf "$TNAME")\033[0m";
echo "";
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo -e '\033[1;43;30m### MR MOLLIK IS IT MOMIN MOLLIK ### \033[0m';
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
...
sed -e "s/\MR_MOLLIK/$PROC/g" .MR_MOLLIK.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
...
echo -e "\e[1;32m
+----------------------------------*/
MR_MOLLIK: (\e[33m12.7.2018\e[32m)
